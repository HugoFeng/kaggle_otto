...
for (fold.index in 1:Num.folds) {
    ...
    fold.test.x <- inputData[fold.test.indices, 2:(Num.totalCol-1)]
    fold.train.x <- inputData[fold.train.indices, 2:(Num.totalCol-1)]
    fold.test.y <- inputData[fold.test.indices, Num.totalCol]
    fold.train.y <- inputData[fold.train.indices, Num.totalCol]
